...
# ----------------------------------------------------------------------------
    ...
    for t in range(Ntot):
        ...
        eta, T = utils.linear_solve_eta(pi, PObs_lim, gamma, rho0, Lx, Ly, Lx0, Ly0, find_range, act_hdl,source_as_zero,solver=solver)
        V, Q = utils.linear_solve_Q(T, Lx, Ly, M, A, gamma, find_range, act_hdl, source_as_zero,RR_np,solver=solver)
